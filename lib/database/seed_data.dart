class SeedData {
  ...
  static const exercises = [
    // === CHEST ===
    {
      ...
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Deite no banco reto, barra na linha do mamilo',
      'equipment': 'Barbell',
    ...
    },
    {
      ...
      'locale_key': 'incl_bench',
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Banco a 30-45°, foco no peito superior',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    {
      ...
      'locale_key': 'decl_bench',
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Banco declinado, foco no peito inferior',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Maior amplitude que barra',
      'equipment': 'Dumbbell',
    ...
    },
    {
      ...
      'locale_key': 'cable_fly',
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Polia alta ou média, contração no centro',
      'equipment': 'Cable',
    ...
    },
    {
      ...
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Máquina de peito sentado',
      'equipment': 'Machine',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Pode variar largura das mãos',
    ...
    },
    {
      ...
      'locale_key': 'chest_dip',
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Tronco inclinado para frente foca peito',
      'equipment': 'Bodyweight',
      'default_rest_time': 90,
      'weight_increment': 0,
    },
    ...
    // === BACK ===
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Pegada pronada, mãos na largura dos ombros',
      'equipment': 'Bodyweight',
      'default_rest_time': 120,
      'weight_increment': 0,
    },
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Pegada supinada, mais bíceps',
      'equipment': 'Bodyweight',
      'default_rest_time': 120,
      'weight_increment': 0,
    },
    {
      'id': 'lat_pulldown',
      'name': 'Puxada Alta',
      'locale_key': 'lat_pulldown',
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Puxar barra até o peito, cotovelos para baixo',
      'equipment': 'Cable',
      'default_rest_time': 90,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Tronco a 45°, barra até o abdômen',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Apoie joelho e mão no banco',
      'equipment': 'Dumbbell',
      'default_rest_time': 90,
      'weight_increment': 2.0,
    },
    {
      'id': 'seated_row',
      'name': 'Remada Sentada',
      'locale_key': 'seated_row',
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Puxar polia até o abdômen, contrair escápulas',
      'equipment': 'Cable',
      'default_rest_time': 90,
      'weight_increment': 2.5,
    },
    ...
    },
    {
      'id': 'face_pull',
      'name': 'Face Pull',
      'locale_key': 'face_pull',
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Puxar polia alta em direção ao rosto, ótimo para postura',
      'equipment': 'Cable',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Barra no chão, costas retas, levantar com pernas e costas',
      'equipment': 'Barbell',
    ...
    },
    {
      ...
      'category_id': 'back',
      'type': 'weightReps',
      'notes': 'Pernas esticadas, barra descendo até canela',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    ...
    // === SHOULDERS ===
    {
      ...
      'type': 'weightReps',
      'notes': 'Barra da frente dos ombros até acima da cabeça',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    ...
    },
    {
      ...
      'locale_key': 'lat_raise',
      'category_id': 'shoulders',
      'type': 'weightReps',
      'notes': 'Halteres subindo lateralmente até altura dos ombros',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    ...
    },
    {
      ...
      'locale_key': 'rear_delt_fly',
      'category_id': 'shoulders',
      'type': 'weightReps',
      'notes': 'Máquina ou halteres, foco no deltoide posterior',
      'equipment': 'Machine',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    {
      'id': 'upright_row',
      'name': 'Remada Alta',
      'locale_key': 'upright_row',
      'category_id': 'shoulders',
      'type': 'weightReps',
      'notes': 'Barra subindo rente ao corpo até o queixo',
      'equipment': 'Barbell',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    {
      ...
      'locale_key': 'arnold_press',
      'category_id': 'shoulders',
      'type': 'weightReps',
      'notes': 'Halteres girando durante o movimento',
      'equipment': 'Dumbbell',
      'default_rest_time': 90,
      'weight_increment': 1.0,
    },
    {
      ...
      'category_id': 'shoulders',
      'type': 'weightReps',
      'notes': 'Elevar os ombros, trapézio',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 5.0,
    },
    ...
    },
    {
      'id': 'hammer_curl',
      'name': 'Rosca Martelo',
      'locale_key': 'hammer_curl',
      'category_id': 'biceps',
      'type': 'weightReps',
      'notes': 'Palmas viradas para dentro',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    {
      'id': 'preacher_curl',
      'name': 'Rosca Scott',
      'locale_key': 'preacher_curl',
      'category_id': 'biceps',
      'type': 'weightReps',
      'notes': 'Braços apoiados no banco Scott',
      'equipment': 'Barbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    {
      'id': 'cable_curl',
      'name': 'Rosca na Polia',
      'locale_key': 'cable_curl',
      'category_id': 'biceps',
      'type': 'weightReps',
      'notes': 'Polia baixa, corda ou barra',
      'equipment': 'Cable',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    {
      ...
      'locale_key': 'concentration_curl',
      'category_id': 'biceps',
      'type': 'weightReps',
      'notes': 'Sentado, cotovelo apoiado na coxa',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    ...
    // === TRICEPS ===
    {
      ...
      'locale_key': 'triceps_pushdown',
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Corda ou barra reta',
      'equipment': 'Cable',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    {
      ...
      'locale_key': 'skull_crusher',
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Deitado, barra descendo até a testa',
      'equipment': 'Barbell',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    {
      'id': 'close_grip',
      'name': 'Supino Fechado',
      'locale_key': 'close_grip',
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Mãos próximas, foco no tríceps',
      'equipment': 'Barbell',
      'default_rest_time': 90,
      'weight_increment': 2.5,
    },
    {
      ...
      'name': 'Tríceps Testa',
      'locale_key': 'triceps_extension',
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Halter atrás da cabeça',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    {
      'id': 'bench_dip',
      'name': 'Mergulho no Banco',
      'locale_key': 'bench_dip',
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Banco atrás, mãos apoiadas, descer com peso',
      'equipment': 'Bodyweight',
      'default_rest_time': 60,
      'weight_increment': 0,
    },
    {
      ...
      'category_id': 'triceps',
      'type': 'weightReps',
      'notes': 'Tronco inclinado, cotovelo fixo',
      'equipment': 'Dumbbell',
      'default_rest_time': 60,
      'weight_increment': 1.0,
    },
    ...
    // === LEGS ===
    {
      ...
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Barra nas costas, descer até paralelo',
      'equipment': 'Barbell',
      'default_rest_time': 180,
      'weight_increment': 5.0,
    },
    ...
    },
    {
      ...
      'locale_key': 'romanian_dl',
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Foco em posterior e glúteo',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Deitado, flexionar pernas',
      'equipment': 'Machine',
      'default_rest_time': 90,
      'weight_increment': 2.5,
    },
    {
      ...
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Pernas estendendo para cima',
      'equipment': 'Machine',
      'default_rest_time': 90,
      'weight_increment': 2.5,
    },
    {
      ...
      'locale_key': 'bulgarian_split',
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Pé de trás no banco, halteres nas mãos',
      'equipment': 'Dumbbell',
      'default_rest_time': 90,
      'weight_increment': 2.0,
    },
    ...
    },
    {
      ...
      'locale_key': 'calf_raise',
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Em pé ou sentado',
      'equipment': 'Machine',
      'default_rest_time': 60,
      'weight_increment': 5.0,
    },
    {
      ...
      'locale_key': 'goblet_squat',
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Halter ou kettlebell na frente do peito',
      'equipment': 'Dumbbell',
      'default_rest_time': 90,
      'weight_increment': 2.0,
    },
    ...
    },
    {
      ...
      'locale_key': 'hip_thrust',
      'category_id': 'legs',
      'type': 'weightReps',
      'notes': 'Barra apoiada no quadril, glúteo',
      'equipment': 'Barbell',
      'default_rest_time': 120,
      'weight_increment': 5.0,
    },
    ...
    },
    {
      ...
      'locale_key': 'leg_raise',
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Deitado, pernas esticadas subindo',
      'equipment': 'Bodyweight',
      'default_rest_time': 45,
      'weight_increment': 0,
    },
    {
      ...
      'category_id': 'core',
      'type': 'timeOnly',
      'notes': 'Manter posição, corpo reto',
      'equipment': 'Bodyweight',
      'default_rest_time': 45,
      'weight_increment': 0,
    },
    {
      'id': 'russian_twist',
      'name': 'Torção Russa',
      'locale_key': 'russian_twist',
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Sentado, girando tronco com peso',
      'equipment': 'Dumbbell',
      'default_rest_time': 45,
      'weight_increment': 0,
    },
    {
      ...
      'locale_key': 'cable_crunch',
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Polia alta, puxar em direção ao chão',
      'equipment': 'Cable',
      'default_rest_time': 45,
      'weight_increment': 2.5,
    },
    {
      'id': 'ab_roller',
      'name': 'Roda de Abdômen',
      'locale_key': 'ab_roller',
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Joelhos ou em pé',
      'equipment': 'Bodyweight',
      'default_rest_time': 60,
      'weight_increment': 0,
    },
    {
      ...
      'locale_key': 'hanging_raise',
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Pendurado na barra, pernas subindo',
      'equipment': 'Bodyweight',
      'default_rest_time': 60,
      'weight_increment': 0,
    },
    ...
    // === CARDIO ===
    {
      'id': 'treadmill',
      'name': 'Esteira',
      'locale_key': 'treadmill',
      'category_id': 'cardio',
      'type': 'distanceTime',
      'notes': 'Caminhada ou corrida',
      'equipment': 'Treadmill',
      'default_rest_time': 0,
      'weight_increment': 0,
    },
    ...
    // === ADDITIONAL CHEST ===
    {
      ...
      'category_id': 'chest',
      'type': 'weightReps',
      'notes': 'Polias altas, puxar para frente e baixo, contrair no centro',
      'equipment': 'Cable',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    ...
    // === ADDITIONAL CORE ===
    {
      ...
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Em posição de prancha, alternar joelhos em direção ao peito',
      'equipment': 'Bodyweight',
      'default_rest_time': 45,
      'weight_increment': 0,
    },
    ...
    },
    {
      ...
      'category_id': 'core',
      'type': 'weightReps',
      'notes': 'Polia alta, girar tronco diagonalmente como se cortasse lenha',
      'equipment': 'Cable',
      'default_rest_time': 60,
      'weight_increment': 2.5,
    },
    ...
    },
    {
      ...
      'category_id': 'cardio',
      'type': 'weightReps',
      'notes': 'Salto lateral de uma perna para a outra, tocando o pé atrás',
      'equipment': 'Bodyweight',
      'default_rest_time': 45,
      'weight_increment': 0,
    },
