  ...
  Future<String> exportNutritionCsv({
    ...
    final csvRows = <List<String>>[
      <String>[
        ...
        loc.exportNutritionHeaderSaturatedFat,
        loc.exportNutritionHeaderMonounsaturatedFat,
        loc.exportNutritionHeaderPolyunsaturatedFat,
        loc.exportNutritionHeaderTransFat,
        loc.exportNutritionHeaderFiber,
        loc.exportNutritionHeaderSugars,
        loc.exportNutritionHeaderSodium,
        loc.exportNutritionHeaderPotassium,
        loc.exportNutritionHeaderCalcium,
        loc.exportNutritionHeaderIron,
        loc.exportNutritionHeaderMagnesium,
        loc.exportNutritionHeaderZinc,
        loc.exportNutritionHeaderVitaminA,
        loc.exportNutritionHeaderVitaminC,
        loc.exportNutritionHeaderVitaminD,
        loc.exportNutritionHeaderVitaminB12,
    ...
    for (final row in rows) {
      csvRows.add(<String>[
        ...
        _formatNumber(row.saturatedFatG, 2),
        _formatNumber(row.monounsaturatedFatG, 2),
        _formatNumber(row.polyunsaturatedFatG, 2),
        _formatNumber(row.transFatG, 2),
        _formatNumber(row.fiberG, 2),
        _formatNumber(row.sugarsG, 2),
        _formatNumber(row.sodiumMg, 1),
        _formatNumber(row.potassiumMg, 1),
        _formatNumber(row.calciumMg, 1),
        _formatNumber(row.ironMg, 2),
        _formatNumber(row.magnesiumMg, 1),
        _formatNumber(row.zincMg, 2),
        _formatNumber(row.vitaminAUg, 1),
        _formatNumber(row.vitaminCMg, 2),
        _formatNumber(row.vitaminDUg, 2),
        _formatNumber(row.vitaminB12Ug, 2),
        row.source ?? '',
