          ...
          FilledButton(
            onPressed: () async {
              if (nameCtl.text.trim().isNotEmpty) {
                await _routineRepo.createRoutine(
                  nameCtl.text.trim(),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.routinesEmptyTitle,
                      style: theme.textTheme.titleLarge,
                    ),
                    const SizedBox(height: 8),
                    Text(
                      AppLocalizations.of(context)!.routinesEmptySubtitle,
...
class _RoutineFormScreenState extends State<RoutineFormScreen> {
      ...
      for (final day in _days) {
        ...
        for (final ex in exercises) {
          ...
          perCategory.putIfAbsent(
            catId,
            () => _RoutineCatStat(name: catName, color: Color(colorVal)),
          );
          ...
          FilledButton(
            onPressed: () async {
              if (ctl.text.trim().isNotEmpty) {
                await _routineRepo.addRoutineDay(
                  widget.routineId,
                  ctl.text.trim(),
                );
                if (ctx.mounted) Navigator.pop(ctx);
        ...
        actions: [
          PopupMenuButton(
            itemBuilder: (ctx) => [
              PopupMenuItem(
                value: 'edit',
                child: Text(AppLocalizations.of(context)!.routinesEdit),
              ),
              PopupMenuItem(
                value: 'delete',
                child: Text(AppLocalizations.of(context)!.routinesDelete),
              ),
            ],
            onSelected: (v) async {
              if (v == 'edit') {
                final nameCtl = TextEditingController(
                  text: _routine?['name'] as String? ?? '',
                );
                final notesCtl = TextEditingController(
                  text: _routine?['notes'] as String? ?? '',
                );
                ...
                final confirm = await showDialog<bool>(
                  ...
                  builder: (ctx) => AlertDialog(
                    title: Text(
                      AppLocalizations.of(
                        context,
                      )!.routinesDeleteConfirm(_routine?['name'] ?? ''),
                    ),
                    content: Text(
                      AppLocalizations.of(context)!.commonActionCannotBeUndone,
                    ),
                    actions: [
                      TextButton(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.routinesDayEmpty,
                      style: theme.textTheme.titleMedium,
                    ),
                    const SizedBox(height: 8),
                    Text(
                      AppLocalizations.of(context)!.routinesDayEmptySubtitle,
                      style: theme.textTheme.bodySmall,
                    ),
                  ],
                ),
  ...
  Widget _buildRoutineDashboard(ThemeData theme) {
    ...
    final cats = dash.perCategory.values.toList()
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          child: AnimatedCrossFade(
            firstChild: _buildDashboardCollapsed(
              theme,
              daysCount,
              totalSets,
              totalVolume,
  ...
  Widget _buildDashboardCollapsed(
    ThemeData theme,
    int daysCount,
    int totalSets,
    double totalVolume,
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  '${totalVolume > 0 ? ' · ${AppLocalizations.of(context)!.routinesWeeklyVolume(totalVolume.toStringAsFixed(0))}' : ''}',
  ...
  Widget _buildDashboardExpanded(
    ThemeData theme,
    List<_RoutineCatStat> cats,
    int totalSets,
    double totalVolume,
      ...
      child: Column(
        ...
        children: [
                  ...
                  Row(
                    children: [
                      ...
                      if (cat.volume > 0) ...[
                        const SizedBox(width: 4),
                        Text(
                          '${cat.volume.toStringAsFixed(0)}kg',
                          style: theme.textTheme.bodySmall?.copyWith(
                            color: theme.colorScheme.onSurfaceVariant,
                          ),
                        ),
          ...
          if (_days.length > 1) ...[
            ...
            Text(
              AppLocalizations.of(context)!.routinesPerDay,
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.routinesDaySets(daySets),
                      style: theme.textTheme.bodySmall?.copyWith(
                        fontWeight: FontWeight.w600,
                      ),
                    ),
