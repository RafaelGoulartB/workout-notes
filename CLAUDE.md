...
On import, the repository runs inference (`SleepInferenceService`) and acoustic staging (`SleepStageAnalysisService`) to fill `estimated_sleep_minutes`, onset/wake, stage minutes, and confidence, and writes `sleep_stage_epochs`.
