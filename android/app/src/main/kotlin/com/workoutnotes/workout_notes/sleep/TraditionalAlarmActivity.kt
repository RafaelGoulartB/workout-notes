...
class TraditionalAlarmActivity : Activity() {
    ...
    private fun render() {
        ...
        if (snapshot.snoozeEnabled) root.addView(Button(this).apply { text = "Sonecar por ${snapshot.snoozeMinutes} min"; setOnClickListener { TraditionalAlarmRingingService.snooze(this@TraditionalAlarmActivity, alarmId); finishAndRemoveTask() } }, LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(54)))
